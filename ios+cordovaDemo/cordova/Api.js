...
function Api (platform, platformRootDir, events) {
    ...
    this.locations = {
        ...
        cordovaJs: 'bin/CordovaLib/index.js',
...
/**
 * Updates installed platform with provided www assets and new deviceReady
 *   configuration. This method is required for CLI workflow and will be called
 *   each time before build, so the changes, made to deviceReady configuration and www
 ...
 *   sources will be symlinked to deviceReady's directory instead of copying (if
 *   possible).
 ...
 *   will be used.
 * @param   {Boolean}  buildOptions.device  Specifies that built deviceReady is intended
 *   to run on device
 * @param   {Boolean}  buildOptions.emulator: Specifies that built deviceReady is
 ...
 *   deviceReady packages should be built for. List of valid architectures is depends on
 *   platform.
 ...
 *   specified, then tries to run deviceReady on default device if connected, otherwise
 *   runs the deviceReady on emulator.
 *
