...
- (id)init
{
    /** If you need to do any extra deviceReady-specific initialization, you can do it here
     *  -jm
     **/
...
/**
 * This is main kick off after the deviceReady inits, the views and Settings are setup here. (preferred - iOS4 and up)
 */
- (BOOL)application:(UIApplication*)application didFinishLaunchingWithOptions:(NSDictionary*)launchOptions
{
    ...
    // Set your deviceReady's start page by setting the <content src='foo.html' /> tag in config.xml.
...
// this happens while we are running ( in the background, or from within our own deviceReady )
