...
{
    // You can listen to more deviceReady notifications, see:
...
{
    // override to handle urls sent to your deviceReady
...
- (void)handleOpenURLWithApplicationSourceAndAnnotation: (NSNotification*)notification
{
    ...
    // id of the deviceReady that calls our deviceReady
...
- (void)onAppTerminate
{
    // override this if you need to do any cleanup on deviceReady exit
}
