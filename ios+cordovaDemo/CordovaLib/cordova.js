    ...
    fireDocumentEvent: function (type, data, bNoDetach) {
        ...
        if (typeof documentEventHandlers[type] !== 'undefined') {
            if (bNoDetach) {
                ...
                setTimeout(function () {
                    // Fire deviceready on listeners that were registered before index.js was loaded.
                    if (type === 'deviceready') {
...
// Wrap in a setTimeout to support the use-case of having plugin JS appended to index.js.
...
exports.load = function (callback) {
    ...
    if (pathPrefix === null) {
        console.log('Could not find index.js script tag. Plugin loading may fail.');
        pathPrefix = '';
    }
